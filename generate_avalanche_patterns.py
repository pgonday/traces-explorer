...
LENDING_POOL_ADDRESSES_PROVIDER_ADDRESS = '0xb6A86025F0FE1862B372cb0ca18CE3EDe02A318f'
...
def load(action, address):
	...
	rsp = requests.get(f'https://api.snowtrace.io/api?module=contract&action={action}&address={address}&apikey={apikey}')
